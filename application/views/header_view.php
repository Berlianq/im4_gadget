...
<head>
  ...
  <title><?php echo $title_web;?> | Sistem Informasi Gadget IM4 </title>
...
<div class="wrapper">
  <header class="main-header"style=" background-color: #04448c;">

    <!-- Logo -->
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span style=" color: white;"><b>IM4</b></span>
      <!-- logo for regular state and mobile devices -->
      <span style=" color: white;">Gadget IM4</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a style=" color: white;"href="<?php echo base_url();?>login/logout">Sign out</a>
          </li>
