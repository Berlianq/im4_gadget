...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bgpal.jpeg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: #04448c;">Sistem Informasi <br/><b>Gadget IM4</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:4px solid #04448c;">
  <h3 class="text-center mt-0 m-b-15">
                        <a href="login.php"><img src="assets_style\image\pal.png" width="200px"></a>
                    </h3>
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <button type="submit" id="loding" class="btn btn-block btn-flat"style=" background-color: #04448c;"><a style="color: White;">Sign In</button>
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center" style=" background-color: #04448c;">
       <a style="color: White;"> Copyright &copy; Sistem IM4 PAL INDONESIA - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
