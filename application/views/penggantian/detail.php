			    ...
			    <div class="box-body">
						<div class="row">
							...
							<div class="col-sm-7">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<table class="table table-striped">
												...
												<tbody>
												<?php 
													$pin = $this->M_Admin->get_tableid('tbl_historipenggantian','pinjam_id',$pinjam->pinjam_id);
													$no=1;
													foreach($pin as $isi)
													{
														$gadget = $this->M_Admin->get_tableid_edit('tbl_gadget','gadget_id',$isi['gadget_id']);
									...
									<tr>
										...
										<td>
										<?php
										$kelengkapans = $this->db->get_where('tbl_historipenggantian', array('pinjam_id' => $pinjam->pinjam_id))->result();
									...
									<tr>
										...
										<td>
											<?php
											$mac_addresses = $this->db->get_where('tbl_historipenggantian', array('pinjam_id' => $pinjam->pinjam_id))->result();
							...
							<div class="col-sm-4 text-center">
									<center>
										<?php
										$form = $this->db->get_where('tbl_historipenggantian', array('pinjam_id' => $pinjam->pinjam_id))->row();
										if ($form) {
											echo '<img src="' . base_url() . 'assets_style/image/' . $form->upd_form . '" style="width:3cm;height:4cm;" class="img-responsive">';
										} else {
											echo 'Form not found';
										}
										?>
