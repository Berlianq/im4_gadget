    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php if($this->uri->uri_string() == 'user'){ echo 'active';}?>
				">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'user'){ echo 'active';}?>
                                ...
                                <a href="<?php echo base_url('user');?>" class="cursor">
                                    <i class="fa fa-user"></i> <span>Data Karyawan</span></a>
                    </li>
                    <li class="<?php if($this->uri->uri_string() == 'user/historikaryawan_view'){ echo 'active';}?>
                                <?php if($this->uri->uri_string() == 'user/tambah'){ echo 'active';}?>
                                <?php if($this->uri->uri_string() == 'user/edit/'.$this->uri->segment('3')){ echo 'active';}?>">
                                <a href="<?php echo base_url('user/historikaryawan_view');?>" class="cursor">
                                    <i class="fa fa-user"></i> <span>Histori Karyawan</span></a>
                    </li>
                </ul>
            </li>
                    ...
                    <li class="<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'data/gadgetdetail/'.$this->uri->segment('3')){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'data/gadgetedit/'.$this->uri->segment('3')){ echo 'active';}?>">
                        <a href="<?php echo base_url("data");?>" class="cursor">
                            <span class="fa fa-book"></span> Data Gadget
            ...
            <li class="treeview 
                ...
                <?php if($this->uri->uri_string() == 'transaksi/penggantian'){ echo 'active';}?>
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'transaksi'){ echo 'active';}?>
                        ...
                        <a href="<?php echo base_url("transaksi");?>" class="cursor">
                            <span class="fa fa-upload"></span> Pemberian
                    ...
                    <li class="<?php if($this->uri->uri_string() == 'transaksi/penggantian'){ echo 'active';}?>">
                        <a href="<?php echo base_url("transaksi/penggantian");?>" class="cursor">
                            <span class="bi bi-arrow-repeat"></span> Penggantian
                        </a>
                    </li>
                </ul>
            </li>
...
?>           
			...
			<?php if($this->session->userdata('level') == 'Anggota'){?>
				...
				<?php if($this->uri->uri_string() == 'data/gadgetdetail/'.$this->uri->segment('3')){ echo 'active';}?>">
					<a href="<?php echo base_url("data");?>" class="cursor">
						<i class="fa fa-search"></i>  <span>Cari gadget</span>
					</a>
				</li>
