                    ...
                    <form action="<?php echo base_url('data/prosesgadget');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Jenis Gadget</label>
                                    <input type="text" class="form-control" name="title" placeholder="Jenis Gadget">
                                </div>
                                <!-- <div class="form-group">
                                    <label>Warna Gadget</label>
                                    <input type="text" class="form-control" name="pengarang" placeholder="Nama Pengarang">
                                </div> -->
                                <div class="form-group">
                                    <label>Warna</label>
                                    <input type="text" class="form-control" name="warna" placeholder="Warna Gadget">
                                </div>
                                <!-- <div class="form-group">
                                    <label>Tahun gadget</label>
                                    <input type="number" class="form-control" name="thn" placeholder="Tahun gadget : 2019">
                                </div> -->
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Stok Tersedia</label>
                                    <input type="number" class="form-control" name="jml" placeholder="Jumlah Gadget">
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    <label>Lampiran gadget <small style="color:green">(pdf) * opsional</small></label>
